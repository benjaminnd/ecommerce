  ...
  return (
    <>
      <div className="flex justify-center">
        <form
          className="bg-white rounded-lg overflow-hidden shadow-2xl p-5 my-16 w-1/2"
          onSubmit={onSubmit}
        >
          ...
          <div className="flex justify-center">
            {isLoading ? (
              <div className="lds-ellipsis object-center">
                <div></div>
                <div></div>
                <div></div>
                <div></div>
              ...
              <Button
                isButton={true}
                title="Login"
                addStyle="bg-primary text-white w-full mb-3"
                action={onSubmit}
                type="submit"
              />
            )}
          ...
          <div className="flex justify-end w-full">
            <Button
              ...
              href="/register"
              addStyle="text-sm italic text-gray-600"
            ></Button>
          </div>
        </form>
      </div>
