...
export const addToCartUser = (_id) => (dispatch) => {
  ...
  const request = axios
    .post(`${serverURL}/api/user/addToCart?productId=${_id}`)
    .then((response) => {
...
export const getCartItems = (cart) => (dispatch) => {
  ...
  const request = axios
    .post(`${serverURL}/api/product/getCartItems?cartItems=${ids}`)
    .then((response) => {
...
export const removeItemUser = (_id) => (dispatch) => {
  ...
  const request = axios
    .post(`${serverURL}/api/user/removeCartItem?cartItem=${_id}`)
    .then((response) => {
...
export const changeQuantity = (_id, quantity) => (dispatch) => {
  ...
  axios
    .post(
      `${serverURL}/api/user/changeItem?cartItem=${_id}&newValue=${quantity}`
    )
    .then((response) => {
      if (response.data.success) {
